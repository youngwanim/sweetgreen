  ...
  products: any = [
    {
      ...
      ingredient: ['ShreddedKale', 'OrganicBabySpinach', 'ChoppedRomaine', 'RoastedChicken', 'WarmPortobelloMix', 'OrganicWildRice', 'RoastedSweetPotato', 'RoastedSesameTofu', 'ShavedParmesan', 'BalsamicVinegar'],
    },
    {
      id: 'salmonster',
      name: '三文鱼大师',
    ...
    },
    {
      ...
      ingredient: ['ShreddedKale', 'OrganicBabySpinach', 'ChoppedRomaine', 'CitrusShrimp', 'Avocado', 'Tomato', 'RawCorn', 'RedOnion', 'Cilantro', 'SpicyRedwineDressing'],
    },
    {
      id: 'green-earth',
      name: '绿色地球',
